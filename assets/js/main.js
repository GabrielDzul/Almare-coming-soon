...
(function($) {
  ...
  function muriel_showSitePart(target) {
    if ($(target).length > 0) {
      ...
      //Hide the overlay on the main page
      if ($(target).hasClass("no-overlay")) {
        $(".global-overlay").hide(500);
      } else {
        $(".global-overlay").show(500);
      }
  ...
  function muriel_backgrounds() {
    ...
    if ($body.hasClass("kenburns-background")) {
      ...
      var kenburnsBackgrounds = [
        { src: "assets/images/slider1.png", valign: "top" },
        { src: "assets/images/slider2.png", valign: "top" },
        { src: "assets/images/slider3.png", valign: "top" },
        { src: "assets/images/slider4.png", valign: "top" }
      ];
